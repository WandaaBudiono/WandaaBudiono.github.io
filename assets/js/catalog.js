            ...
            <div class="card border-light-subtle clean-product-item">
              ...
              <div class="card-body">
                ...
                <div class="about text-center">
                  ...
                  <div class="price text-success fw-bold">
                    <a class="btn btn-info" onclick="product.add(${product})">Add to cart</a>
                  </div>
                </div>
              </div>
            </div>
